...
\cvitem{OOPSLA 2027}{PC member in ACM SIGPLAN International Conference on Object-Oriented Programming, Systems, Languages, and Applications (OOPSLA)}
\cvitem{FSE 2027}{PC member in International Conference on the Foundations of Software Engineering (FSE)}
\cvitem{ICSE 2027}{PC member in International Conference on Software Engineering}
\cvitem{ICSE 2026}{PC member in International Conference on Software Engineering}
\cvitem{KDD 2026}{Reviewer in ACM SIGKDD Conference on Knowledge Discovery and Data Mining}
