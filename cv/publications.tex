...
\bibitem{cdc}
Lize Shao, Michael Cardei, Zichen Xie,  Ferdinando Fioretto, \textbf{Wenxi Wang}.
\emph{``Constrained Code Generation with Discrete Diffusion''}, In \textit{The Fortieth Annual Conference on Neural Information Processing Systems \\(Neurips 2026)}. 
\href{https://arxiv.org/abs/2605.16829}{\color{color1}{\textbf{[PDF]}}}

\bibitem{vericontest}
Zichen Xie, Mrigank Pawagi, Yuxin Liu,  Aaditi Rai, 
Lize Shao, John Berberian Jr., Sicong Che, \textbf{Wenxi Wang}.
\emph{``VeriContest: A Competitive-Programming Benchmark
	for Verifiable Code Generation''}, In \textit{The Fortieth Annual Conference on Neural Information Processing Systems \\(Neurips 2026, Evaluation and Dataset Track)}.
\href{https://arxiv.org/abs/2605.08553}{\color{color1}{\textbf{[PDF]}}}


	
\bibitem{vcotbench}
{{ \underline{Zichen Xie}, \textbf{Wenxi Wang}.
		\emph{``Can LLMs Reason Like Automated Theorem Provers for Rust Verification? VCoT-Bench: Evaluating via Verification Chain of Thought''}
		In \textit{The forty-third International Conference on Machine Learning\\(ICML 2026)}. 
		\href{https://arxiv.org/pdf/2603.18334}{\color{color1}{\textbf{[PDF]}}}}}


\bibitem{llm4mutant}
{{ \underline{Arjun Tandon}, Mehmet Fırat Dündar, Milkiyas Gebremichael Gebru, Darko Marinov, Yiling Lou, \textbf{Wenxi Wang}.
		\emph{``Re-evaluating Detection of Equivalent Mutants Using LLMs: We Should Properly Measure How Far We Are''}
		In \textit{The 35th ACM SIGSOFT International Symposium on Software Testing and Analysis\\(ISSTA 2026)}. 
	\color{color1}{\faAward~\textbf{ACM SIGSOFT Distinguished Paper Award}}.
		\href{https://wenxiwang.github.io/papers/LLM4Mutant-evel.pdf}{\color{color1}{\textbf{[PDF]}}}}}


\bibitem{inlinetest}
{{ \underline{Chaitanya Shahane}, \underline{Derek Hansen}, \textbf{Wenxi Wang}, Pengyu Nie
		\emph{``Differential Inline Testing: Framework, Test Generation, and Application''}
		In \textit{The 36th IEEE International Conference on Collaborative Advances in Software and Computing \\ (CASCON 2026)}  (to appear). }}


\bibitem{rfcscope}
{{ \underline{Mrigank Pawagi}, \underline{Lize Shao}, Hyeonmin Lee, Yixin Sun, \textbf{Wenxi Wang}.
		\emph{``RFCScope: Detecting Logical Ambiguities in Internet Protocol Specifications''}
		In \textit{The 40th IEEE/ACM International Conference on Automated Software Engineering\\(ASE 2025)}. \href{https://wenxiwang.github.io/papers/rfcscope/rfcscope_paper.pdf}{\color{color1}{\textbf{[PDF]}}}}}
