...
\begin{thebibliography}{99} % Use a suitable number here based on the widest label
	...
	\bibitem{llm4mutant}
	{{ {Arjun Tandon}, Mehmet Fırat Dündar, Milkiyas Gebremichael Gebru, Darko Marinov, Yiling Lou, \textbf{Wenxi Wang}.
	 ...
	 \bibitem{rfcscope}
	{{ {Mrigank Pawagi}, Lize Shao, Hyeonmin Lee, Yixin Sun, \textbf{Wenxi Wang}.
