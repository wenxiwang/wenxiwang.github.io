...
%\footnote{* denotes that these authors contribute equally to the paper.}
 \cvitem{}{Published \emph{16 refereed conference papers and 2 refereed journal papers}.  My papers were accepted at top-tier venues in software engineering (ICSE, ESEC/FSE, ASE, ESEC/FSEDemo), formal methods
...
\begin{thebibliography}{99} % Use a suitable number here based on the widest label
	% Entry 4
	 ...
	 \bibitem{rfcscope}
	{ \color{red}{{Mrigank Pawagi}, Lize Shao, Hyeonmin Lee, Yixin Sun, \textbf{Wenxi Wang}.
